...
const extraMetadata = {
  external_url: "https://notatallcats.com", // Replace with your website or remove this line if you do not have one.
};
...
const CONTRACT_NAME = 'Not at all cats';
const CONTRACT_SYMBOL = 'NAAC';
...
const ROYALTY_ADDRESS = "0x788491eC09C59901b3C5ec4F379555945d7762fC"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = ["0x788491eC09C59901b3C5ec4F379555945d7762fC"]; // only update if you want to manually set the whitelisted addresses

// ** OPTIONAL **
let CONTRACT_ADDRESS = "0x7da35CaB56E99A63c2C53479deBF9979A1aaFc32"; // If you want to manually include it

// Generic Metadata is optional if you want to reveal your NFTs
const GENERIC = true; // Set to true if you want to upload generic metas and reveal the real NFTs in the future
const GENERIC_TITLE = CONTRACT_NAME; // Replace with what you want the generic titles to say if you want it to be different from the contract name.
const GENERIC_DESCRIPTION = "Meowww!!??"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafybeiajiyupmgcklbgg3ujnzxzb3k7lejhso4ptlv6wythbrk5tygmnhi"; // Replace with your generic image that will display for all NFTs pre-reveal.
